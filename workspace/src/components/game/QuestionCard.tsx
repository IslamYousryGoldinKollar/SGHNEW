...
export default function QuestionCard({ question, onAnswer, className }: QuestionCardProps) {
  ...
  return (
    <Card className={cn("h-full flex flex-col transition-all duration-300 relative", className)}>
      <CardHeader>
